...
- Phần mềm máy CANcomp, tên hiển thị **BM AutoCan** (repo riêng, 25/09/2026): [BM_CANXE_SOFT_CANcomp](https://github.com/nguyenmian3012-code/BM_CANXE_SOFT_CANcomp) — nghe RS232, lọc cao nguyên, SQLite, sync. Đổi ingest hoặc luật kg thì sửa **cả** repo đó.
