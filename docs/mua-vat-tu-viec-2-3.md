...
|---|---|---|---|---|
| 1 | Cáp **USB → RS232 chip FTDI** (Z-Tek ZE533A hoặc tương đương FT232) | **2** | Một cám máy bột, một cám đầu cân. **Không** mua dây hồng CH340 nếu có FTDI | ~300–350k/sợi |
| 2 | Cáp RS232 **DB9 đực – DB9 cái**, bọc, 1,5–2 m | 1–2 | Nối dài nếu máy tính sample xa | ~50–80k |
| 3 | Đầu chuyển **DB25 cái → DB9 đực** (hoặc cái–cái + giới) | 1 | Kingbird COM thường 25 chân; USB-RS232 là 9 chân | ~40–70k |
| 4 | Đầu hàn DB9 đực + DB9 cái + vỏ ốp kim loại | 2 bộ | Chỉ khi phải **tự hàn tap** việc 2 | ~80–120k |

Phần mềm (miễn phí): **CoolTerm** (dễ nhất) hoặc RealTerm. Bật log file + hiện ASCII và Hex.

**Không mua:** cáp Y DB9 “1 đực 2 cái” nối thẳng cả 9 chân — hai máy cùng TX làm sổ cũ loan.

---

## Việc 3 — máy đo củ mì (làm trước khi 2 kẹt)

Máy đã có RS232. Nếu cổng đó **chưa** cắm máy khác: cắm thẳng USB-RS232 vào, không cần chia.

1. Laptop / PC sample, cài CoolTerm + driver FTDI.
2. Cắm cáp vào máy bột. Device Manager Windows phải thấy `COMx` (ví dụ COM3).
3. CoolTerm: chọn đúng COM, **9600, 8 bit, None, 1 stop**, Connection → Open. Bật Display Hex + gân file log.
